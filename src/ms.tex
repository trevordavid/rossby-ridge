...
%Stars reach Ro = 2 at very roughly halfway through the MS, and stay there until the MS turnoff. For higher mass stars with MS lifetimes of 4 Gyr, it means that stars on the ridge should have a ~2 Gyr age spread. For stars with 10 Gyr MS lifetimes, it should be something close to a 5 Gyr age spread. 
