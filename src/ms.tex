...
\citet{vanSaders2019} addressed this issue in detail...}
...
\edit1{We also note that the short-period pile-up is not as prominent in the \lamostsan sample, compared to the \lamostmcq sample (see the rightmost panels of Figure~\ref{fig:xmatch}). The differences between the \citet{McQuillan2014} and \citet{Santos2021} catalogs may provide an explanation for this observation: the latter catalog contains a much larger number of detections at longer rotation periods. The higher sensitivity to more slowly rotating stars within the \citet{Santos2021} may then make the short-period pile-up appear weaker relative to the long-period pile-up, as expected since open cluster obsbervations suggest that the short-period pile-up can not be a long-lived feature.}
