...
\edit1{To this point, we have not addressed the detection biases inherent to Kepler rotation period catalogs. As rotation periods become longer, it becomes more difficult to measure periods directly from rotational brightness modulations in Kepler time series. This is true for at least three reasons: (1) the Kepler baseline is finite, (2) photometric variation amplitude declines with increasing rotation period, and (3) photometric variations tend to become less periodic with increasing rotation period.}
